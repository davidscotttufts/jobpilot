...
Independent track · Status: **todo** · Added 2026-07-15 · Builds on: [t3-public-jobs-page.md](t3-public-jobs-page.md) infra (done), the Pilot's promotion feature (M3)
...
A user can toggle the page on, promo/outreach links point at it, it renders the active resume
+ portfolio server-side (SEO), and a Pilot-proposed refresh after a resume change is one-tap
approvable.
