---
name: verify
description: Run the full JobPilot CI gate locally - Biome, API + web typechecks, API tests, and the terminal .NET tests when terminal files changed. Use before committing, or when asked to "verify", "run checks", or "run the gate".
---
...
5. Only if the working tree or branch diff touches `apps/terminal/` or `tests/`
